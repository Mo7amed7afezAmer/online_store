...
class Governorate(models.Model):
    govern = models.CharField(max_length= 255, blank=True, null=True, verbose_name=_('governorate'))
    charge   = models.PositiveIntegerField(default=0, verbose_name=_('charge'))
